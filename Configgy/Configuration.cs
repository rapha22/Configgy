...
namespace Configgy
{
    class Configuration
    {
        public static ConfiggyServerOptions GetOptions(string[] args)
        {
            return ParseArguments(args);
        }

        private static ConfiggyServerOptions ParseArguments(string[] args)
        {
        ...
        private static ConfiggyServerOptions ReadConfigurationFile(string[] args)
        {
